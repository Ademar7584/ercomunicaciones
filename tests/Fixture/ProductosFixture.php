...
class ProductosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'marca' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'modelo' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'estado' => 1,
            'categoria_id' => 1,
            'created' => '2019-04-26 20:16:33',
            'modified' => '2019-04-26 20:16:33'
        ],
    ];
}
